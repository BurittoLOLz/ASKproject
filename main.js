// Global Variables
const addCurrencybtn = document.querySelector(".add-currencies-btn");
const addCurrencyList = document.querySelector(".add-currencies-list");
const currenciesList = document.querySelector(".currencies");

const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=2c53ccabe44bdddbc4c3ec97b8c3f923";

const initallyDisplayedCurrencies = ["MYR", "USD", "EUR", "GBP", "JPY", "RUB"];
let baseCurrency;
...
let currencies = [
    {
        ...
        abbreviation: "USD",
        symbol: "\u0024",
        flagURL: "https://img.geonames.org/flags/l/us.gif"
    },
    {
        name: "Euro",
        abbreviation: "EUR",
...
function populateCurrenciesList() {
  for(let i=0; i<initallyDisplayedCurrencies.length; i++) {
    const currency = currencies.find(c => c.abbreviation===initallyDisplayedCurrencies[i]);
